...
export const SEED_VIDEOS: SeedVideo[] = [
  { hook: 'Personne ne viendra te sauver.', niche: 'motivation', plat: 'yt', status: 'published', bg: 'linear-gradient(150deg,#A56A00,#7C2D12)', views: '42,8K', likes: '3,1K', dur: '0:22', rate: '8,4%' },
  ...
  { hook: 'La règle des 2 minutes qui change tout.', niche: 'growth', plat: 'both', status: 'published', bg: 'linear-gradient(150deg,#FF8A5C,#C72B7A)', views: '76,2K', likes: '5,8K', dur: '0:27', rate: '9,1%' },
